...
image_mask6 = Image("mask6", "masks/mask6.png")
...
container.images.Add(image_mask6)
...
container.sprites.Add(Sprite("weapon_static19", set_weapons, 18, 13, 4, 4)) # mask6 / armor

container.sprites.Add(Sprite("weapon_static20", set_weapons, 2, 25, 2, 3)) # invis
container.sprites.Add(Sprite("weapon_static21", set_weapons, 7, 6, 6, 3)) # flame rifle / bubbler
container.sprites.Add(Sprite("weapon_static22", set_weapons, 2, 12, 4, 4)) # shuriken
container.sprites.Add(Sprite("weapon_static23", set_weapons, 4, 16, 3, 4)) # cs bomb
container.sprites.Add(Sprite("weapon_static24", set_weapons, 10, 28, 4, 4)) # ball
