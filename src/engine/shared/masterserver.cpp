...
public:
	...
	virtual void SetDefault()
	{
		...
		for(int i = 0; i < MAX_MASTERSERVERS; i++)
			str_format(m_aMasterServers[i].m_aHostname, sizeof(m_aMasterServers[i].m_aHostname), "0.0.0.0");

		str_format(m_aMasterServers[0].m_aHostname, sizeof(m_aMasterServers[0].m_aHostname), "vps301894.ovh.net");
		str_format(m_aMasterServers[1].m_aHostname, sizeof(m_aMasterServers[1].m_aHostname), "[2607:fcd0:100:1903::5da2:f18e]");
	}
