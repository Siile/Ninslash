...
bool CGameControllerGunGame::IncreaseScore(class CPlayer *pWhom)
{
	pWhom->m_Score++;
...
bool CGameControllerGunGame::DecreaseScore(class CPlayer *pWhom)
{
...
const int CGameControllerGunGame::GetStage(class CPlayer *pWhom) const
{
